                ...
                <div class="overflow-hidden bg-white shadow sm:rounded-lg">
                    <div class="px-4 py-5 sm:px-6">
                        <div class="flex justify-between">
                            <h3 class="text-lg font-medium leading-6 text-gray-900">{{ member.first_name }} {{ member.surname }}</h3>
                            <Link type="button" :href="origin" class="inline-flex rounded-md bg-white text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                                <span class="sr-only">Close</span>
                                <XMarkIcon class="h-5 w-5" aria-hidden="true" />
                            </Link>
                        </div>
                        <div class="flex justify-between">
                            <p class="mt-1 text-sm text-gray-500">{{ birthday }} <span v-if="death_day"> - {{ death_day }}</span></p>
