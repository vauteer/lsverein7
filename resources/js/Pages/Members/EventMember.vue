...
let deleteEventMember = () => {
    ...
    router.delete(`/members/${props.memberId}/event/${props.eventMember.id}`);
};
...
<template>
    ...
    <MyConfirmation v-if="showDeletion" @canceled="showDeletion = false" @confirmed="deleteEventMember">
        Ereignis löschen
    </MyConfirmation>
</template>
