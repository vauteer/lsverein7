...
<template>
    <MyLayout>
                            ...
                            <div class="space-y-8 divide-y divide-gray-200 my-3 mx-2">
                                ...
                                <div class="py-5">
                                    <div class="flex justify-between">
                                        <MyButton v-if="deletable" theme="abort" @click="showConfirmation = true">
                                            Löschen
                                        </MyButton>
        ...
        <MyConfirmation v-if="showConfirmation" @canceled="showConfirmation = false" @confirmed="deleteRole">
